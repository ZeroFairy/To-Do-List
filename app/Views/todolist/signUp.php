...
<head>
    ...
    <title>SignUp Pengguna ToDoList</title>
...
<div class="container mt-3 p-5 border border-4 border-dark">
    <div class="container mt-1 p-2 border border-3 border-dark bg-info">
        <h1 class="text-center text-white">SignUp Pengguna ToDoList</h1>
    </div>

    <form method="post" action="/ToDoList/signup">
        <?= csrf_field() ?>
        ...
        <div class="form-group row mt-3">
            <label for="conf_password" class="col-2 col-form-label">Confirm Password</label>
            <div class="col-10">
                <input type="text" class="form-control border border-2 border-dark" name="conf_password" id="conf_password">
            </div>
        </div>
